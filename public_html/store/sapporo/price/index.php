		...
		<div id="cont_hidden_wrap">
			...
			<h1 class="l_lowerTitle">
				...
				<section class="l_flow">
					...
					<h2 class="l_section_title"><span class="small">片付け堂〇〇店</span><br>料金表<span class="en">PLAN</span></h2>
				...
				<section class="price__about price_base_color_olta price_base_space">
					...
					<ul class="price__about_list">
						<li>
							<h3><span class="num">01</span><span>下見含め<br class="sp"><span class="color_yellow">見積もり無料</span></span></h3>
							<figure>
								<img src="/assets/img/price/about_img01.svg" alt="もちろん無料！">
							</figure>
						</li>
						<li>
							<h3><span class="num">02</span><span>キャンセル料<span class="color_yellow">無料</span></span></h3>
							<figure>
								<img src="/assets/img/price/about_img02.svg" alt="もちろん無料！">
							</figure>
						</li>
						<li>
							<h3><span class="num">03</span><span>追加料金<span class="color_yellow">一切なし</span></span></h3>
							<figure>
								<img src="/assets/img/price/about_img03.svg" alt="追加料金なし！">
							</figure>
						</li>
					</ul>
					<p>
					...
					<div class="price__about_method">
						<h3>選べるお支払い方法</h3>
						<p>この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。この文章はダミーです。この文章はダミーです。この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。</p>
						<dl>
							<dt>現金</dt>
						</dl>
						<dl>
							...
							<dd>
								...
								<figure>
									<picture>
										<source media="(max-width: 640px)" srcset="/assets/img/price/sp/method_img01.png">
										<img src="/assets/img/price/method_img01.png" alt="受付のお電話時に「Tポイント キャンペーンを見た !」">
									</picture>
								</figure>
								<p>
									※店舗により使用できない場合がございますので、詳しくは店舗スタッフにお問い合わせ下さい。
								</p>
							</dd>
						</dl>
						<dl>
							...
							<dd>
								...
								<figure>
									<picture>
										<source media="(max-width: 640px)" srcset="/assets/img/price/sp/method_img02.png">
										<img src="/assets/img/price/method_img02.png" alt="受付のお電話時に「Tポイント キャンペーンを見た !」">
									</picture>
								</figure>
								<p>
									※店舗により使用できない場合がございますので、詳しくは店舗スタッフにお問い合わせ下さい。
...
<div class="pricelist__search-pc_3title">
	<ul>
		...
		<li><span>●</span>2tトラック未満の単品料金はベットお見積させていただきます。</li>
		<li><span>●</span>以下単品料金は参考料金となり、品物の大きさ、搬出距離、作業状況により変動いたしますのでご了承ください。</li>
...
<ul class="pricelist__about_list">
		...
		<li>
			<h3><span>積込作業</span></h3>
			<figure>
				<img src="/assets/img/5content_02.png" alt="">
			</figure>
		</li>
		<li>
			<h3><span>収集運搬</span></h3>
			<figure>
				<img src="/assets/img/5content_03.png" alt="">
			</figure>
		</li>
		<li>
			<h3><span>処分</span></h3>
			<figure>
				<img src="/assets/img/5content_04.png" alt="">
			</figure>
		</li>
		<li>
			<h3><span>養生作業</span></h3>
			<figure>
				<img src="/assets/img/5content_05.png" alt="">
			</figure>
		</li>
</ul>
</div>

				<div class="pricelist__price_pack green">
						<h4><span class="main">シングルお気軽パック</span><span class="sub">単身赴任・学生の一人暮らしのお部屋をお片付け致します。</span></h4>
						<div class="detail">
							<ul class="sum">
							...
							<div class="amount">
								<div class="inr">
									<p class="text">処分量<br>軽トラ</p>
									<p class="num"><strong>1</strong>台</p>
								</div>
								<p class="size">(１～1.5m3)</p>
							</div>
							<figure>
								<img src="/assets/img/pricelist/cmn/price_obj01.svg" alt="">
							</figure>
						</div>
						<div class="total">
							<div class="price">
								<p class="unit">一式</p>
								<p class="num"><strong>20,000</strong>円～<span class="tax">(税込)</span></p>
							</div>
							<div class="tpoint">
								<img src="/assets/img/tpoint.svg" alt="T-POINT">
								<p>Tポイント<br class="sp"><span class="num"><strong>200</strong>pt</span>〜貯まります！</p>
							</div>
						</div>
					</div>
					<div class="pricelist__price_pack blue">
						<h4><span class="main">迅速パック</span><span class="sub">迅速で安全・格安な2tトラックに載せ放題パック！</span></h4>
						<div class="detail">
							<ul class="sum">
								<li><span>運賃<br>(2t<br class="sp">トラック車)</span></li>
								<li><span>処分費用</span></li>
							...
							<div class="amount">
								<div class="inr">
									<p class="text">処分量</p>
									<p class="num"><strong>2</strong>t車</p>
								</div>
								<p class="size">(軽トラ2台分)</p>
							</div>
							<figure>
								<img src="/assets/img/pricelist/cmn/price_obj02.svg" alt="">
							</figure>
						</div>
						<div class="total">
							<div class="price">
								<p class="unit">一式</p>
								<p class="num"><strong>35,000</strong>円～<span class="tax">(税込)</span></p>
							</div>
							<div class="tpoint">
								<img src="/assets/img/tpoint.svg" alt="T-POINT">
								<p>Tポイント<br class="sp"><span class="num"><strong>350</strong>pt</span>〜貯まります！</p>
							</div>
						</div>
					</div>
					<div class="pricelist__price_pack orange">
						<h4><span class="main">安心パック</span><span class="sub">お部屋・キッチン・風呂等の掃き・拭き掃除・お部屋の片付け等。</span></h4>
						<div class="detail">
							<ul class="sum">
								<li><span>運賃<br>(4t<br class="sp">トラック車)</span></li>
								<li><span>処分費用</span></li>
								<li><span>作業<br class="sp">スタッフ<br>2名</span></li>
							</ul>
							<div class="amount">
							...
							<figure>
								<img src="/assets/img/pricelist/cmn/price_obj03.svg" alt="">
							</figure>
						</div>
						<div class="total">
							<div class="price">
								<p class="unit">一式</p>
								<p class="num"><strong>60,000</strong>円～<span class="tax">(税込)</span></p>
							</div>
							<div class="tpoint">
								<img src="/assets/img/tpoint.svg" alt="T-POINT">
								<p>Tポイント<br class="sp"><span class="num"><strong>600</strong>pt</span>〜貯まります！</p>
							</div>
						</div>
					</div>
					<ul class="pricelist__price_notes">
						<li>地域によって料金パックが変動しますので、詳細の料金についてはお問い合わせ下さい。</li>
				...
				<section class="l_contact plaise_contact_top">
					<h2>
						<picture>
							...
							<img src="/assets/img/contact_header.svg" alt="">
						</picture>
					</h2>
					<p>
					...
					<div class="l_contact__tel">
						...
						<div class="l_contact__tel_cont">
							...
							<span class="icon-arrow sp">
								<svg xmlns="http://www.w3.org/2000/svg" width="5" height="8" viewBox="0 0 5.035 8.43"><g transform="translate(0.548 0.548)"><g transform="translate(0 0)"><path d="M121.645,3.489,118.231.084a.286.286,0,1,0-.4.405l3.211,3.2-3.212,3.2a.286.286,0,0,0,.4.405l3.415-3.405a.286.286,0,0,0,0-.405Z" transform="translate(-117.742 0)" stroke-linecap="round" stroke-width="1"></path></g></g></svg>
							</span>
					...
					<div class="l_contact__other">
						...
						<div class="l_contact__t-point">
							<figure>
								<img src="/assets/img/tpoint.svg" alt="">
							</figure>
...
<ul class="pricelist__about_list">
		...
		<li>
			...
			<figure>
				...
				<div class="price_base_color flex_block">	
					<div class="pricelist__about_method">
						<h3><strong class="color_str">ゴミ屋敷清掃</strong>の料金参考例</h3>
						<div>
							<dl>
								<dd>
									<div class="pricelist__search-pc_plicelist">
				...
				<div class="price_base_color flex_block">	
					<div class="pricelist__about_method">
						<h3><strong class="color_str">オプション</strong>作業料金</h3>
						<div>
							<dl>
								<dd>
									<div class="pricelist__search-pc_plicelist">
...
<div class="price_base_color flex_block">	
					<div class="pricelist__about_method">
						<h3><strong class="color_str">遺品整理</strong>の料金参考例</h3>
						<div>
							<dl>
								<dd>
									<div class="pricelist__search-pc_plicelist">
				...
				<div class="price_base_color flex_block">	
					<div class="pricelist__about_method">
						<h3><strong class="color_str">遺品供養・お焚き上げ</strong>の料金参考例</h3>
						<div>
							<dl>
								<dd>
									<div class="pricelist__search-pc_plicelist">
				...
				<div class="price_base_color flex_block">	
					<div class="pricelist__about_method">
						<h3><strong class="color_str">特殊清掃・消毒消臭</strong>サービスの参考料金</h3>
						<div>
							<dl>
								<dd>
									<div class="pricelist__search-pc_plicelist">
...
<ul>
	...
	<li><span>●</span>以下単品料金は参考料金となり、品物の大きさ、搬出距離、作業状況により変動いたしますのでご了承ください。</li>
			...
			<div class="price_base_color">
				<div class="pricelist__about_method plaise_height">
...
<div class="price_kaitori">
			<img src="/assets/img/kaitori.png" alt="">
					...
					<div class="pricelist__search-pc_buytitle">
						<h3>生活家電</h3>
						<p>この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。</p>
					</div>



				<div class="price_lower__canbuy_list">

					<div class="item">
							<div class="price_lower__canbuy_img"><img src="/assets/img/ico_line.svg" alt="LINE"></div>
							<div class="price_lower__canbuy_cate">111111111111</div>
							<div class="price_lower__canbuy_bland">ブランド</div>
							<div class="price_lower__canbuy_name">111111111111</div>
