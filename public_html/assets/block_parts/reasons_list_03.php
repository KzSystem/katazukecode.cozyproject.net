<ul class="l_5reasons__list">
    <li>
        <h3><span class="num">01</span><span>安心の<br><span class="color_yellow">許可業者</span></span></h3>
        <figure>
            <img  class="l_5reasons__img_08" src="/assets/img/service/hoarding_house/apartment/reason_01.jpg" alt="イメージ">
        </figure>
    </li>
    <li>
