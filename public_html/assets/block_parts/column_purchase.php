				<section class="l_contact column_contact_child column_card_purchase">
				<div class="column_card">
					...
					<div class="column_card_block">
						<div class="column_card_block01">
							<p><span>片付け堂では、</span><br><strong class="marker">不用品買取・家電や家具などの出張買取</strong>を全国各地で承っております。</p>
							<img src="/assets/img/about_obj_purchase.svg" alt="LINE">
						</div>
						<div class="katazuke_logos">
							<img src="../../../../assets/img/logo.svg" alt="LINE">
						</div>
						<ul class="blog__article_checklist column_checklist">
										<li class="item">古物商許可を取得した「許可業者」だから、<strong class="marker">任せて安心！</strong></li>
										<li class="item">不用品買取から片付けまでを<strong class="marker">ワンストップ対応！</strong></li>
										<li class="item">不用品買取のプロが伺うので、初めての出張買取でも<strong class="marker">安心してお任せ！</strong></li>
						</ul>
						
						<div class="column_card_block03">
							<p>不用品のことでお困りなら、片付け堂の<br>無料相談をお気軽にご利用ください</p>
							<img src="../../../../assets/img/service/lower/trouble_obj05.png" alt="LINE">
						</div>
    ...
    <h2>
        <picture>
            ...
            <img src="/assets/img/omakase.png" alt="「下見」「お見積」相談無料！　お気軽にお問合わせ下さい！">
        </picture>
    </h2>
    
    
        <div class="column_img">
        		<img src="/assets/img/sp/sptell_soudan.svg" alt="「下見」「お見積」相談無料！　お気軽にお問合わせ下さい！" class="sp">      
        		<img src="/assets/img/tell_soudan.svg" alt="「下見」「お見積」相談無料！　お気軽にお問合わせ下さい！" class="pc">
        </div>
    
<!--
    <div class="l_contact__tel">
        <h3>お電話でのご相談はこちらから<span class="pc">お気軽にご連絡ください！</span></h3>
        <div class="l_contact__tel_cont column_card_callphone">
...
-->
    <div class="l_contact__inr">
        <a class="l_contact__line" href="">
            <div class="icon small_line"><img src="/assets/img/ico_line.svg" alt="LINE"></div>
            <span>
                LINEで30秒！<br class="pc">
                簡単お見積り
            </span>
            <figure class="qr pc">
                <img src="/assets/img/qr.svg" alt="QRコード" class="small_qr">
            </figure>
    ...
    <div class="l_contact__other">
        <div class="l_contact__credit column_creditcard">
            <figure>
                <picture>
<source media="(max-width: 640px)" srcset="/assets/img/sp/credit.png">                    <img src="/assets/img/sp/credit.png" alt="対応クレジットカード">
                </picture>
            </figure>
