...
<html lang="ja">
	<head>
		...
		<title>生前整理の料金 | 不用品回収・粗大ゴミ回収なら片付け堂</title>
	...
	<body>
		<div id="cont_hidden_wrap">
			...
			<main id="price_lower" class="price_lower life">
				...
				<div id="breadcrumb" class="breadcrumb">
					<ul itemscope itemtype="https://schema.org/BreadcrumbList">
						...
						<li class="active" itemscope itemprop="itemListElement" itemtype="https://schema.org/ListItem">
							<span itemprop="name">生前整理の料金</span>
							<meta itemprop="position" content="3" />
						</li>
					</ul>
				</div>
				<section class="price_lower__plans">
					<h2 class="l_section_title">生前整理の料金の<br class="sp">仕組み<span class="en">PRICE PLANS</span></h2>
					...
					<ul class="price_lower__plans_list">
						<li class="item">
							...
							<h3 class="price_lower__plans_list_title">車両費</h3>
						...
						<li class="item">
							<figure class="price_lower__plans_list_img">
								<img src="../../assets/img/price/plan_obj03.jpg" alt="イメージ">
							</figure>
						...
						<li class="item">
							<figure class="price_lower__plans_list_img">
								<img src="../../assets/img/price/plan_obj04.jpg" alt="イメージ">
							</figure>
							<h3 class="price_lower__plans_list_title">家電リサイクル料金</h3>
							<p class="price_lower__plans_list_text">
								この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。
							</p>
						</li>
						<li class="item">
							<figure class="price_lower__plans_list_img">
								<img src="../../assets/img/price/plan_obj05.jpg" alt="イメージ">
							</figure>
						...
						<li class="item">
							<figure class="price_lower__plans_list_img">
								<img src="../../assets/img/price/plan_obj06.jpg" alt="イメージ">
							</figure>
					...
					<div class="price_lower__plans_ex">
						...
						<div class="price_lower__plans_ex_detail">
							<div class="flex_wrap">
								<div class="price_lower__plans_ex_detail_box">
									...
									<div class="price_lower__plans_ex_detail_inr">
										<figure class="price_lower__plans_ex_detail_img">
											<img src="../../assets/img/price/sample_obj01.svg" alt="イメージ">
										</figure>
								...
								<div class="price_lower__plans_ex_detail_box">
									...
									<div class="price_lower__plans_ex_detail_inr">
										<figure class="price_lower__plans_ex_detail_img">
											<img src="../../assets/img/price/sample_obj03.svg" alt="イメージ">
										</figure>
										<p class="price_lower__plans_ex_detail_text">
											この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。この文章はダミーです。
										</p>
						...
						<div class="price_lower__plans_ex_other">
							...
							<div class="price_lower__plans_ex_other_inr">
								...
								<div class="price_lower__plans_ex_other_box">
									<figure class="price_lower__plans_ex_other_img">
										<img src="../../assets/img/price/sample_obj06.svg" alt="イメージ">
									</figure>
									<p class="price_lower__plans_ex_other_name">
										その他オプション費用
									</p>
				...
				<section class="price_lower__sample">
					...
					片付け堂の</span><br>生前整理の料金参考例<span class="en">SAMPLE PRICE</span></h2>
					<p class="l_section_lead">
					...
					<div class="price_lower__sample_recommend">
						...
						<ul class="price_lower__sample_recommend_nav">
							<li class="n01 item active"><span>生前整理をして<br>不用品を処分したい</span></li>
							<li class="n02 item"><span>生前整理をして<br>不用品処分と<br class="sp">買取りもしたい</span></li>
						</ul>
							...
							<ul class="price_lower__sample_recommend_list">
								<li class="item">
									<figure class="price_lower__sample_recommend_img">
										<img src="../../assets/img/price/recommend_obj17.svg" alt="イメージ">
									</figure>
									<h4 class="price_lower__sample_recommend_point">
										自分では手に負えない<br class="pc">ので<br class="sp">手伝ってほしい
									</h4>
								...
								<li class="item">
									<figure class="price_lower__sample_recommend_img">
										<img src="../../assets/img/price/recommend_obj18.svg" alt="イメージ">
									</figure>
									<h4 class="price_lower__sample_recommend_point">
										終活をして<br class="pc">将来の<br class="sp">準備をしたい
									</h4>
									<p class="price_lower__sample_recommend_text">
										この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。
									</p>
								...
								<li class="item">
									<figure class="price_lower__sample_recommend_img">
										<img src="../../assets/img/price/recommend_obj19.svg" alt="イメージ">
									</figure>
									<h4 class="price_lower__sample_recommend_point">
										子供に<br class="pc">迷惑を<br class="sp">かけたくない
									</h4>
									<p class="price_lower__sample_recommend_text">
										この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。
									</p>
								...
								<li class="item">
									...
									<h4 class="price_lower__sample_recommend_point">
										大量にある不用品<br class="sp">を<br class="pc">整理したい
									</h4>
									<p class="price_lower__sample_recommend_text">
										この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。
									</p>
						...
						<div class="price_lower__sample_recommend_content n02">
							<ul class="price_lower__sample_recommend_list">
								<li class="item">
									<figure class="price_lower__sample_recommend_img">
										<img src="../../assets/img/price/recommend_obj21.svg" alt="イメージ">
									</figure>
									<h4 class="price_lower__sample_recommend_point">
										使用していない<br class="sp">貴金属を<br>買取りしてほしい
									</h4>
									<p class="price_lower__sample_recommend_text">
										この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。
									</p>
								...
								<li class="item">
									...
									<h4 class="price_lower__sample_recommend_point">
										不用品処分と<br class="sp">買取りを<br>一緒にしたい
									</h4>
									<p class="price_lower__sample_recommend_text">
										この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。
									</p>
								...
								<li class="item">
									<figure class="price_lower__sample_recommend_img">
										<img src="../../assets/img/price/recommend_obj22.svg" alt="イメージ">
									</figure>
									<h4 class="price_lower__sample_recommend_point">
										使用していない<br class="sp">品物を<br class="pc">換金したい
									</h4>
									<p class="price_lower__sample_recommend_text">
										この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。
									</p>
				...
				<section class="price_lower__trouble">
					...
					<ul class="price_lower__trouble_check">
						<li class="item">
							訪問見積りで聞いていた料金の<strong class="marker">2倍の料金を生前整理費用として請求された</strong>
						</li>
						<li class="item">
							生前整理の<strong class="marker">出張見積りを依頼しただけで不当な請求にあった</strong>
						</li>
						<li class="item">
							生前整理の際に出てきた<strong class="marker">金やネックレスなどの貴重品を盗難されてしまった</strong>
						</li>
						<li class="item">
							大切にしてきた<strong class="marker">遺品や形見を不法投棄されてしまった</strong>

						</li>
					</ul>
					<div class="price_lower__trouble_counter">
						<h3 class="price_lower__trouble_counter_title">生前整理の<br class="sp">料金トラブルを防ぐためには</h3>
						...
						<div class="price_lower__trouble_counter_list">
							<ol class="l_list_number">
								<li>見積書は書面でもらい、<strong class="color_green">条件面や追加料金の有無を確認</strong>する。</li>
								<li>作業を依頼する際は、<strong class="color_green">必要な許可の有無を事前に確認</strong>する。</li>
								<li>信頼できる業者かどうか<strong class="color_green">口コミやお客様の声をチェック</strong>しておく。</li>
							</ol>
						</div>
					</div>
				</section>
				<section class="price_lower__case">
					...
					<div class="price_lower__case_box purple">
						<div class="flex-wrap">
							...
							<table class="price_lower__quote_table">
								...
								<tbody class="price_lower__quote_table_tbody">
									<tr class="price_lower__quote_table_tr">
										...
										<td class="price_lower__quote_table_item">1〜2時間</td>
				...
				<section class="price_lower__tips">
					...
					<ul class="price_lower__tips_list">
						<li class="item">
							<div class="price_lower__tips_top">
								<figure class="price_lower__tips_img">
									<img src="../../assets/img/price/tips_obj12.jpg" alt="イメージ">
								</figure>
						...
						<li class="item">
							<div class="price_lower__tips_top">
								<figure class="price_lower__tips_img">
									<img src="../../assets/img/price/tips_obj13.jpg" alt="イメージ">
								</figure>
								<div class="price_lower__tips_num">
									<span>02</span>
								</div>
						...
						<li class="item">
							<div class="price_lower__tips_top">
								<figure class="price_lower__tips_img">
									<img src="../../assets/img/price/tips_obj03.jpg" alt="イメージ">
								</figure>
								<div class="price_lower__tips_num">
									<span>03</span>
								</div>
							...
							<h3 class="price_lower__tips_title">
								買取りしてほしい品物を<br class="pc">仕分けしておく
							</h3>
							<p class="price_lower__tips_text">
								この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。
							</p>
						...
						<li class="item">
							<div class="price_lower__tips_top">
								<figure class="price_lower__tips_img">
									<img src="../../assets/img/price/tips_obj14.jpg" alt="イメージ">
								</figure>
								<div class="price_lower__tips_num">
									<span>04</span>
								</div>
						...
						<li class="item">
							<div class="price_lower__tips_top">
								<figure class="price_lower__tips_img">
									<img src="../../assets/img/price/tips_obj15.jpg" alt="イメージ">
								</figure>
								<div class="price_lower__tips_num">
									<span>05</span>
								</div>
							...
							<h3 class="price_lower__tips_title">
								現地での<br class="sp">見積りを<br class="sp">依頼する
							</h3>
							<p class="price_lower__tips_text">
								この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。
							</p>
						...
						<ul class="price_lower__merit_list">
							<li class="item">
								...
								<h3 class="price_lower__merit_point">
									短時間で<br class="pc">生前整理<br class="sp">が完了する
								</h3>
							...
							<li class="item">
								...
								<h3 class="price_lower__merit_point">
									分別から<br class="pc">全て依頼<br class="sp">できるので安心
								</h3>
								<p class="price_lower__merit_text">
									この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。
								</p>
							...
							<li class="item">
								...
								<h3 class="price_lower__merit_point">
									買取りして<br class="sp">処分費<br class="sp">を安くできる
								</h3>
								<p class="price_lower__merit_text">
									この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。
								</p>
					...
					<div class="price_lower__merit_content n02">
						<ul class="price_lower__merit_list">
							...
							<li class="item">
								...
								<h3 class="price_lower__merit_point">
									業者との<br>料金トラブル<br class="sp">がある
								</h3>
								<p class="price_lower__merit_text">
									この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。
								</p>
							...
							<li class="item">
								<figure class="price_lower__merit_img">
									<img src="../../assets/img/price/demerit_obj10.svg" alt="イメージ">
								</figure>
								<h3 class="price_lower__merit_point">
									どんな業者がくる<br class="sp">か<br class="pc">分からない
								</h3>
								<p class="price_lower__merit_text">
									この文章はダミーです文字の大きさ・量・字間・行間等を確認するために入れています。
								</p>
					...
					<div class="price_lower__merit_cautions">
						...
						<div class="price_lower__merit_cautions_list">
							<ol class="l_list_number">
								...
								<li class="item">
									複数業者へ見積り依頼し、適正価格か判断する。
								</li>
								<li class="item">
									口コミや評判を確認して、安心できる業者か判断する。
								</li>
								<li class="item">
									実在している会社かHPで運営会社を確認する。
								</li>
							</ol>
						</div>
					</div>
				...
				<div class="l_btn_wrap_flex">
					...
					<a class="l_btn_more" href="">
						<span class="l_btn_more__wrap">
							<span class="point">生</span><span class="point">前</span><span class="point">整</span><span class="point">理</span><span class="point">サ</span><span class="point">ー</span><span class="point">ビ</span><span class="point">ス</span>について<br class="sp">詳しく見る
							<span class="icon-arrow">
								<svg xmlns="https://www.w3.org/2000/svg" width="5" height="8" viewBox="0 0 5.035 8.43"><g transform="translate(0.548 0.548)"><g transform="translate(0 0)"><path d="M121.645,3.489,118.231.084a.286.286,0,1,0-.4.405l3.211,3.2-3.212,3.2a.286.286,0,0,0,.4.405l3.415-3.405a.286.286,0,0,0,0-.405Z" transform="translate(-117.742 0)" stroke-linecap="round" stroke-width="1"/></g></g></svg>
							</span>
						</span>
